...
const SignUp = () => {
    ...
    return (
        ...
        <div className='px-4 py-1.5'>
           ...
           <input type="file" name="" onChange={(e) => setFile(e.target.files[0])} className='w-full h-10 border-2 py-[3px] border-gray-300 px-2 rounded-md placeholder:text-md placeholder:font-medium text-md font-medium focus:outline-sky-500'/>
            </div>
        <div className='px-4 py-1.5'>
