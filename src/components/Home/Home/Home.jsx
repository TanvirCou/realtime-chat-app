...
const Home = () => {
    ...
    return (
        <div className="bgImg">
            <div className={`absolute w-full flex flex-col items-center ${active ? "top-10" : "top-4"} md:top-8`}>
                <div className="bg-white w-4/5 sm:w-3/5 md:w-1/2 lg:w-1/3 py-3 font-[Poppins] font-bold text-3xl text-center rounded mb-2">
                    <p>Panda-Chat</p>
                </div>
                <div className="bg-white w-4/5 sm:w-3/5 md:w-1/2 lg:w-1/3 py-2 md:py-4 rounded-md">
