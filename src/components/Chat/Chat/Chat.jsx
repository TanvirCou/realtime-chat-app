        ...
        <div className='bgImg'>
            <div className="">
                ...
                <div className="flex justify-center">
                    <div className={`md:w-1/3 w-full ${selectedChat ? "max-md:hidden" : "max-md:flex"} h-[59vh] md:h-[90vh] p-2`}>
                    ...
                    <div className={`md:w-2/3 w-full ${selectedChat ? "max-md:flex" : "max-md:hidden"}  h-[59vh] md:h-[90vh] p-1 md:p-2`}>
                        <div className="w-full h-full bg-white rounded-md">
